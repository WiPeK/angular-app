...
import {ExecutionStatusComponent} from './domestic/execution-status/execution-status.component';
...
@NgModule({
  ...
  declarations: [DomesticComponent, BeneficiariesDialogComponent, SelectedBeneficiariesListComponent,
    SummaryComponent, ScheduledTransferComponent, SpecSchTransferComponent, ScheduledTransferComponent, ExecutionStatusComponent],
